    ...
    handler: () => {
      window.location.href = "/zh-cn/";
          ...
          section: "动态",handler: () => {
            ...
            },},{id: "news-祝贺张硕卿和洪鑫在-journal-of-the-american-chemical-society-上发表了论文-mechanisms-and-origins-of-chemo-and-regioselectivities-of-ru-ii-catalyzed-decarboxylative-c-h-alkenylation-of-aryl-carboxylic-acids-with-alkynes-a-computational-study",
          title: '祝贺张硕卿和洪鑫在《Journal of the American Chemical Society》上发表了论文《Mechanisms and Origins of Chemo- and Regioselectivities of...',
          description: "",
          section: "动态",handler: () => {
          ...
          section: "动态",handler: () => {
            ...
            },},{id: "news-祝贺张硕卿和汤缪炅在-scientific-data-上发表了论文-qm9star-two-million-dft-computed-equilibrium-structures-for-ions-and-radicals-with-atomic-information",
          title: '祝贺张硕卿和汤缪炅在《Scientific Data》上发表了论文《QM9star, two Million DFT-computed Equilibrium Structures for Ions and Radicals with Atomic...',
          description: "",
          section: "动态",handler: () => {
          ...
          section: "动态",handler: () => {
            ...
            },},{id: "news-祝贺吴镕凯和洪鑫在-science-advances-上发表了论文-rhodium-catalyzed-atropodivergent-hydroamination-of-alkynes-by-leveraging-two-potential-enantiodetermining-steps",
          ...
          section: "动态",handler: () => {
            ...
            },},{id: "news-祝贺张硕卿和洪鑫在-inorganics-上发表了论文-theoretical-study-on-the-ortho-para-reactivity-difference-in-ru-catalyzed-amination-of-aminopyridines-via-η6-coordination-role-of-meisenheimer-intermediate-coordination-ability",
          title: '祝贺张硕卿和洪鑫在《Inorganics》上发表了论文《Theoretical Study on the Ortho–Para Reactivity Difference in Ru-Catalyzed Amination of Aminopyridines via...',
          description: "",
          section: "动态",handler: () => {
          ...
          section: "动态",handler: () => {
            ...
            },},{id: "news-祝贺张硕卿和汤缪炅在-nature-communications-上发表了论文-unveiling-mechanistic-patterns-of-copper-catalyzed-radical-bond-formation-through-linear-free-energy-relationship",
          title: '祝贺张硕卿和汤缪炅在《Nature Communications》上发表了论文《Unveiling mechanistic patterns of copper-catalyzed radical bond formation through linear free energy...',
          description: "",
          section: "动态",handler: () => {
